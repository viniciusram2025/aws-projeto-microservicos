...
public class ProductService {
  ...
  public void updateProductStock(ProductStockDTO product) {
    try {
      ...
      log.error("Error while trying to update stock from message with error: {}", ex.getMessage(), ex);
  ...
  public SalesProductResponse getSalesByProductID(Integer productId) {
    try{
      ...
      log.info("Sending GET request to order by productId with data {} | [transactionID: {} | serviceID: {}]",
